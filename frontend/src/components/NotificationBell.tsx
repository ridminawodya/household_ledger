  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute top-0.5 right-0.5 flex items-center justify-center min-w-[16px] h-4 px-1 rounded-full bg-red-500 text-[10px] font-semibold text-white animate-pop">
